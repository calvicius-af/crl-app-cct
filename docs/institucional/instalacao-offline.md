...
2. **Integridade.** O `MANIFESTO.txt` regista o SHA-256 de cada ficheiro, e o
   ...
   Isto é integridade, não autenticidade: o manifesto segue dentro da mesma
   pasta que verifica e não é assinado, pelo que não resiste a quem altere as
   duas coisas de propósito — ver
