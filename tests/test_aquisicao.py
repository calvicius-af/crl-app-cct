...
def test_corrida_completa_escreve_so_os_documentos_sem_aviso(tmp_path, monkeypatch):
    ...
    do RNC (ADR-0022), não no de 2025."""
    ...
    assert pdfs == ["2026_BTE_31_PRI_377_CCT_27251_ACRAL-CESP.pdf",
                    "2026_BTE_31_PRI_378_CCT-ALT_26760_CNIS-FNSTFPS.pdf",
                    "2026_BTE_31_PRI_379_CCT-ALT_26651_AEVP-FESAHT.pdf"]
    relatorio = next((tmp_path / "relatorios").glob("relatorio_*.txt")).read_text(
        encoding="utf-8")
    assert "2026_BTE_31_PRI_377_CCT_27251_ACRAL-CESP" in relatorio
...
def test_corrida_completa_produz_a_pasta_do_pipeline_com_aceitar_heuristicas(
    ...
    assert pdfs == ["2026_BTE_31_PRI_377_CCT_27251_ACRAL-CESP.pdf",
                    "2026_BTE_31_PRI_378_CCT-ALT_26760_CNIS-FNSTFPS.pdf",
                    "2026_BTE_31_PRI_379_CCT-ALT_26651_AEVP-FESAHT.pdf",
                    "2026_BTE_31_PRI_385_AE-ALT_47140_APSolutionsGMBH-STAS.pdf",
                    "2026_BTE_31_SPE_382_AE_47252_EmpresaMetropolitana-SINTAP.pdf",
                    "2026_BTE_31_SPE_387_AE-ALT-RECT_47109_CARRISTUR-Transportes.pdf"]
    relatorio = next((tmp_path / "relatorios").glob("relatorio_*.txt")).read_text(
        encoding="utf-8")
    assert "2026_BTE_31_PRI_377_CCT_27251_ACRAL-CESP" in relatorio
    assert "Rede: autorizada" in relatorio
