...
| [0006](0006-colunas-cortam-cabecalhos-centrados.md) | O corte em duas colunas parte cabeçalhos centrados (pdfplumber) | Resolvida |
...
| [0010](0010-python-do-projeto-em-windows.md) | Em Windows, não é claro qual o Python do projeto, e o doctor não ajuda | Resolvida |
